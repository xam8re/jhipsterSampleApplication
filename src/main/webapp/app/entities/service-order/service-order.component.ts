...
export class ServiceOrderComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    if (this.currentSearch) {
      this.serviceOrderService
        ...
        .subscribe(
          (res: HttpResponse<IServiceOrder[]>) => this.paginateServiceOrders(res.body, res.headers),
  ...
  trackId(index: number, item: IServiceOrder) {
    return item.id;
  }

  registerChangeInServiceOrders() {
    this.eventSubscriber = this.eventManager.subscribe('serviceOrderListModification', response => this.loadAll());
  }
  ...
  private paginateServiceOrders(data: IServiceOrder[], headers: HttpHeaders) {
