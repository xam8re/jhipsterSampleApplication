...
export class ServiceRequestComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    if (this.currentSearch) {
      this.serviceRequestService
        ...
        .subscribe(
          (res: HttpResponse<IServiceRequest[]>) => this.paginateServiceRequests(res.body, res.headers),
  ...
  trackId(index: number, item: IServiceRequest) {
    return item.id;
  }
  ...
  private paginateServiceRequests(data: IServiceRequest[], headers: HttpHeaders) {
