...
describe('Service Tests', () => {
  describe('ServiceOffer Service', () => {
    ...
    beforeEach(() => {
      ...
      injector = getTestBed();
      service = injector.get(ServiceOfferService);
    ...
    describe('Service methods', () => {
      it('should call correct URL', () => {
        ...
        const resourceUrl = SERVER_API_URL + 'api/service-offers';
        expect(req.request.url).toEqual(resourceUrl + '/' + 123);
      });

      it('should create a ServiceOffer', () => {
        service.create(new ServiceOffer(null)).subscribe(received => {
      ...
      it('should update a ServiceOffer', () => {
        service.update(new ServiceOffer(123)).subscribe(received => {
      ...
      it('should return a ServiceOffer', () => {
      ...
      it('should return a list of ServiceOffer', () => {
        ...
        const req = httpMock.expectOne({ method: 'GET' });
        req.flush([new ServiceOffer(123)]);
      });
