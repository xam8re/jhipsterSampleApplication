...
import { ServiceOfferComponent } from 'app/entities/service-offer/service-offer.component';
...
describe('Component Tests', () => {
  describe('ServiceOffer Management Component', () => {
    let comp: ServiceOfferComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ServiceOfferComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.serviceOffers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
