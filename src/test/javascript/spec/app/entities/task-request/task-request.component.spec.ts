...
import { TaskRequestComponent } from 'app/entities/task-request/task-request.component';
...
describe('Component Tests', () => {
  describe('TaskRequest Management Component', () => {
    let comp: TaskRequestComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TaskRequestComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.taskRequests[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
