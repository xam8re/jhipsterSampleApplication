  ...
  describe('Manufacturer Service', () => {
    ...
    describe('Service methods', () => {
      it('should call correct URL', () => {
        ...
        const resourceUrl = SERVER_API_URL + 'api/manufacturers';
        expect(req.request.url).toEqual(resourceUrl + '/' + 123);
      });

      it('should create a Manufacturer', () => {
        service.create(new Manufacturer(null)).subscribe(received => {
      ...
      it('should update a Manufacturer', () => {
        service.update(new Manufacturer(123)).subscribe(received => {
      ...
      it('should return a list of Manufacturer', () => {
        ...
        const req = httpMock.expectOne({ method: 'GET' });
        req.flush([new Manufacturer(123)]);
      });
