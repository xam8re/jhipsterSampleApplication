...
describe('Service Tests', () => {
  describe('ServiceOrder Service', () => {
    ...
    beforeEach(() => {
      ...
      injector = getTestBed();
      service = injector.get(ServiceOrderService);
    ...
    describe('Service methods', () => {
      it('should call correct URL', () => {
        ...
        const resourceUrl = SERVER_API_URL + 'api/service-orders';
        expect(req.request.url).toEqual(resourceUrl + '/' + 123);
      });

      it('should create a ServiceOrder', () => {
        service.create(new ServiceOrder(null)).subscribe(received => {
      ...
      it('should update a ServiceOrder', () => {
        service.update(new ServiceOrder(123)).subscribe(received => {
      ...
      it('should return a ServiceOrder', () => {
      ...
      it('should return a list of ServiceOrder', () => {
        ...
        const req = httpMock.expectOne({ method: 'GET' });
        req.flush([new ServiceOrder(123)]);
      });
