...
import { TaskOrderComponent } from 'app/entities/task-order/task-order.component';
...
describe('Component Tests', () => {
  describe('TaskOrder Management Component', () => {
    let comp: TaskOrderComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TaskOrderComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.taskOrders[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
