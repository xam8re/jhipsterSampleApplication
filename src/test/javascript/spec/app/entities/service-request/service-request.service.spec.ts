  ...
  describe('ServiceRequest Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a ServiceRequest', () => {
        service.create(new ServiceRequest(null)).subscribe(received => {
      ...
      it('should update a ServiceRequest', () => {
        service.update(new ServiceRequest(123)).subscribe(received => {
      ...
      it('should return a ServiceRequest', () => {
      ...
      it('should return a list of ServiceRequest', () => {
        ...
        const req = httpMock.expectOne({ method: 'GET' });
        req.flush([new ServiceRequest(123)]);
      });
