...
import { MachineModelComponent } from 'app/entities/machine-model/machine-model.component';
...
describe('Component Tests', () => {
  describe('MachineModel Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.machineModels[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
