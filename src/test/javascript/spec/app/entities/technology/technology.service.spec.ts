  ...
  describe('Technology Service', () => {
    ...
    describe('Service methods', () => {
      it('should call correct URL', () => {
        ...
        const resourceUrl = SERVER_API_URL + 'api/technologies';
        expect(req.request.url).toEqual(resourceUrl + '/' + 123);
      });

      it('should create a Technology', () => {
        service.create(new Technology(null)).subscribe(received => {
      ...
      it('should update a Technology', () => {
        service.update(new Technology(123)).subscribe(received => {
